...
export const apiGenre = () => __awaiter(void 0, void 0, void 0, function* () {
    const url = "https://api.themoviedb.org/3/genre/movie/list?api_key=YOUR_API_KEY&language=it-IT";
    const headers = {
