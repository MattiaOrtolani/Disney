export const apiMulti = async (query, page = 1) => 
{
    const result = await fetch(`https://api.themoviedb.org/3/search/multi?page=${page}&query=${encodeURIComponent(query)}`,
    {
        headers: {
