export const apiSeriesGenre = async (page: number = 1, genreId: number): Promise<any> =>
{
    const url: string = `https://api.themoviedb.org/3/discover/tv?with_genres=${genreId}&page=${page}`;
